...
export async function POST(request) {
  try {
    ...
    const result = await client.query(
      'INSERT INTO aluno, responsavel (foto, matricula_aluno, nome_aluno, cpf_aluno, cartao_sus_aluno, data_nasc_aluno, identidade_aluno) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *',
      [foto, matricula_aluno, nome_aluno, cpf_aluno, cartao_sus_aluno, data_nasc_aluno, identidade_aluno]
    );
    await client.query(
      'INSERT INTO responsavel (nome_resp, cpf_resp, identidade_resp, comprov_resid_resp, contato_resp, email_resp) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *',
      [nome_resp, cpf_resp, identidade_resp, comprov_resid_resp, contato_resp, email_resp]
    )
    client.release();
